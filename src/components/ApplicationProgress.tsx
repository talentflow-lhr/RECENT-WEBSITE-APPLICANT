...
import { Building2, Calendar, MapPin, DollarSign, CheckCircle, Clock, XCircle, AlertCircle, FileText, Mail, Phone } from 'lucide-react';
  ...
  const [applications, setApplications] = useState([
    {
      ...
      timeline: [
        ...
        { stage: 'Technical Interview', date: 'Nov 25, 2025', completed: false, upcoming: true },
        { stage: 'Final Interview', date: 'Pending', completed: false },
                ...
                return (
                  <>
                    ...
                    <div className="mt-6 flex gap-3">
                      <button className="flex-1 bg-[#ffca1a] hover:bg-[#e6b617] text-gray-900 px-6 py-3 rounded-lg transition-colors flex items-center justify-center gap-2" onClick={handleViewApplication}>
                        <FileText className="w-5 h-5" />
                        <span>View Application</span>
                      </button>
                      {app.statusType !== 'rejected' && app.statusType !== 'accepted' && (
                        <button className="flex-1 bg-white hover:bg-gray-50 text-gray-900 px-6 py-3 rounded-lg border-2 border-gray-200 transition-colors" onClick={handleWithdrawApplication}>
